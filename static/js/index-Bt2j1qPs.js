...
import { M as oe } from "./motion-QXd5bTiu.js";
import {
  j as se,
  c as ie,
  u as re,
...
import { l as fe, m as de } from "./verifyCode-ClJjFBam.js";
import { K as he, W as me } from "./ajmer.utils-BPzkq30X.js";
import { u as ve } from "./@vueuse-ChwCXi05.js";
import { _ as ye } from "./LoginPhone.vue_vue_type_script_setup_true_lang-BJbw9RI5.js";
import { _ as ge } from "./LoginRegist.vue_vue_type_script_setup_true_lang-BBL8WyNo.js";
import { _ as _e } from "./LoginUpdate.vue_vue_type_script_setup_true_lang-BuZl1Xus.js";
import { _ as we } from "./LoginQrCode.vue_vue_type_script_setup_true_lang-CHMqebyh.js";
import {
  V as be,
  a3 as xe,
  a4 as je,
...
import { _ as ke } from "./_plugin-vue_expo.js";
import "./ajmer.theme-DjcWgsEv.js";
import "./pinia-DIp8UqE1.js";
import "./mitt-CNZ6avp8.js";
import "./js-cookie-BXEMiIsG.js";
import "./@iconify-DIDSJ0LL.js";
    ...
    a.value &&
      (t.value = (function (e, l, a) {
        ...
        const o = "0123456789",
          s = e.getContext("2d");
        if (!s) return t;
        (s.fillStyle = Te(180, 230)), s.fillRect(0, 0, l, a);
        for (let i = 0; i < 4; i += 1) {
...
const Fe = {
    render: function (e, l) {
      return I(), P("svg", Le, [...De]);
    }
  },
  He = (e) => (le("data-v-912696e0"), (e = e()), ae(), e),
  $e = { class: "select-none" },
  qe = ["src"],
  Ze = { class: "flex-c absolute right-5 top-3" },
  Be = { class: "check-en" },
      ...
      n(r({}, { name: "Login" }), {
        ...
        setup(e) {
          ...
          const a = S(""),
            ...
            n = S(),
            T = L(() => ce().currentPage),
            { initStorage: E } = (function () {
              const { $storage: e, $config: l } = he();
              return {
                initStorage: () => {
          ...
          E();
          const { dataTheme: z, overallStyle: le, dataThemeChange: ae } = c();
          ae(le.value);
          const {
              title: te,
              getDropdownItemStyle: ke,
              getDropdownItemClass: Me
            } = p(),
            { locale: Se, translationCh: Te, translationEn: Oe } = ne(),
            Ue = D({ username: "admin", password: "admin123", verifyCode: "" }),
            Le = (e) => {
              return (
                (l = this),
                (a = null),
                    ...
                    U("div", Ae, [
                      U("div", Qe, [
                        ...
                        0 === R(T)
                          ...
                          : Z("", !0),
                        1 === R(T) ? (I(), $(ye, { key: 2 })) : Z("", !0),
                        2 === R(T) ? (I(), $(we, { key: 3 })) : Z("", !0),
                        3 === R(T) ? (I(), $(ge, { key: 4 })) : Z("", !0),
                        4 === R(T) ? (I(), $(_e, { key: 5 })) : Z("", !0)
                      ])
                    ])
                  ])
                ])
