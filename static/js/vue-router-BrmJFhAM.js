...
function L(e) {
  return null == e
    ? ""
    : (function (e) {
        return A(e).replace(v, "%23").replace(E, "%3F");
      })(e).replace(b, "%2F");
}
function M(e) {
  try {
...
function _(e, t, n = "/") {
  ...
  return (
    ...
    { fullPath: r + (a && "?") + a + s, path: r, query: o, hash: M(s) }
  );
}
function I(e, t) {
...
function U(e, t) {
  return g(e) ? F(e, t) : g(t) ? F(t, e) : e === t;
}
function F(e, t) {
  return g(t)
  ...
  const t = (function (e) {
      ...
      return (
          ...
          ),
        {
          ...
          state: o,
          push: function (e, n) {
            const s = h({}, o.value, t.state, { forward: e, scroll: Y() });
            a(s.current, s, !0),
              a(
                e,
                h({}, ne(r.value, e, null), { position: s.position + 1 }, n),
                !1
              ),
              (r.value = e);
          },
          replace: function (e, n) {
            a(
              e,
              h({}, t.state, ne(o.value.back, e, o.value.forward, !0), n, {
    ...
    n = (function (e, t, n, r) {
      ...
      function l() {
        ...
        e.state && e.replaceState(h({}, e.state, { scroll: Y() }), "");
      }
      return (
...
var ce, le;
function ie(e, t) {
  return h(new Error(), { type: e, [se]: !0 }, t);
}
function ue(e, t) {
  return e instanceof Error && se in e && (null == t || !!(e.type & t));
}
((le = ce || (ce = {}))[(le.aborted = 4)] = "aborted"),
  (le[(le.cancelled = 8)] = "cancelled"),
  (le[(le.duplicated = 16)] = "duplicated");
const fe = "[^/]+?",
  pe = { sensitive: !1, strict: !1, start: !0, end: !0 },
  he = /[.+*?^${}()[\]/\\]/g;
function de(e, t) {
  let n = 0;
...
function be(e, t, n) {
  const r = (function (e, t) {
      ...
      (function (e) {
        ...
        return (
          2 === n && t(`Unfinished custom RegExp for param "${i}"`), f(), s(), o
        );
      })(e.path),
      n
    ),
...
function we(e, t) {
  ...
  function s(e) {
    const t = (function (e, t) {
      ...
      const o = (function (e) {
        let t = e;
        for (; (t = t.parent); ) if (Pe(t) && 0 === me(e, t)) return t;
        return;
      })(e);
      o && (r = t.lastIndexOf(o, r - 1));
      return r;
    })(e, n);
    n.splice(t, 0, e), e.record.name && !ke(e) && r.set(e.record.name, e);
  }
  return (
    ...
    e.forEach((e) => o(e)),
    {
      ...
      resolve: function (e, t) {
        let o,
          ...
          c = {};
        if ("name" in e && e.name) {
          if (((o = r.get(e.name)), !o)) throw ie(1, { location: e });
          (s = o.record.name),
            (c = h(
              Ee(
                t.params,
          ...
          if (
            ...
            throw ie(1, { location: e, currentLocation: t });
          (s = o.record.name),
        ...
        return { name: s, path: a, params: c, matched: l, meta: Oe(l) };
      },
      removeRoute: a,
...
function Ce(e) {
  ...
  for (let r = 0; r < n.length; ++r) {
    const e = n[r].replace(R, " "),
      o = e.indexOf("="),
      a = M(o < 0 ? e : e.slice(0, o)),
      s = o < 0 ? null : M(e.slice(o + 1));
    if (a in t) {
      let e = t[a];
...
function je(e) {
  ...
  for (let n in e) {
    const r = e[n];
    if (((n = q(n).replace(w, "%3D")), null == r)) {
      void 0 !== r && (t += (t.length ? "&" : "") + n);
      continue;
    }
    (g(r) ? r.map((e) => e && q(e)) : [r && q(r)]).forEach((e) => {
      void 0 !== e &&
            ...
            s.then((a) => {
              if (!a)
                return Promise.reject(
                  new Error(`Couldn't resolve component "${e}" at "${c.path}"`)
                );
              const s =
                (l = a).__esModule || "Module" === l[Symbol.toStringTag]
                  ? a.default
                  : a;
              var l;
              c.components[e] = s;
              const i = (s.__vccOpts || s)[t];
              return i && Ge(i, n, r, c, e, o)();
            })
          );
        }
    }
...
function Ie(e) {
  const n = o(qe),
    ...
    s = c(() => {
      ...
      const s = o.findIndex(W.bind(null, n));
      if (s > -1) return s;
      const c = De(e[t - 2]);
      return t > 1 && De(n) === c && o[o.length - 1].path !== c
        ? o.findIndex(W.bind(null, e[t - 2]))
        : s;
    }),
    l = c(
      () =>
...
const We = a({
  ...
  setup(e, { slots: t }) {
    const n = s(Ie(e)),
      { options: r } = o(qe),
      a = c(() => ({
        [Ue(e.activeClass, r.linkActiveClass, "router-link-active")]:
          n.isActive,
        [Ue(
          e.exactActiveClass,
...
const Ue = (e, t, n) => (null != e ? e : null != t ? t : n);
function Fe(e, t) {
  if (!e) return null;
  const n = e(t);
    ...
    return (
      ...
      () => {
        const t = s.value,
          ...
          a = m.value,
          c = a && a.components[o];
        if (!c) return Fe(r.default, { Component: c, route: t });
        const i = a.props[o],
          u = i
            ? !0 === i
              ? t.params
        ...
        return Fe(r.default, { Component: f, route: t }) || f;
      }
    );
  }
});
function Ve(o) {
  const a = we(o.routes, o),
    s = o.parseQuery || Ce,
    c = o.stringifyQuery || je,
    l = o.history,
    i = Be(),
    u = Be(),
    f = Be(),
  ...
  const b = d.bind(null, (e) => "" + e),
    w = d.bind(null, L),
    E = d.bind(null, M);
  function R(e, t) {
    if (((t = h({}, t || v.value)), "string" == typeof e)) {
      const n = _(s, e, t.path),
    ...
    let n;
    if (null != e.path) n = h({}, e, { path: _(s, e.path, t.path).path });
    else {
      const r = h({}, e.params);
      for (const e in r) null == r[e] && delete r[e];
      (n = h({}, e, { params: w(r) })), (t.params = w(t.params));
    }
    ...
    const i = (function (e, t) {
      ...
      c,
      h({}, e, {
        hash: ((u = o), A(u).replace(C, "{").replace($, "}").replace(x, "^")),
        path: r.path
      })
    );
    var u;
    ...
    return h(
      { fullPath: i, hash: o, query: c === je ? $e(e.query) : e.query || {} },
      r,
      { redirectedFrom: void 0, href: f }
    );
  }
  function k(e) {
    return "string" == typeof e ? _(s, e, v.value.path) : h({}, e);
  }
  function O(e, t) {
    if (y !== e) return ie(8, { from: t, to: e });
  }
  function P(e) {
    return S(e);
  }
  function j(e) {
    ...
    if (t && t.redirect) {
      ...
      return (
        "string" == typeof r &&
          ((r = r.includes("?") || r.includes("#") ? (r = k(r)) : { path: r }),
          (r.params = {})),
        h(
          {
            query: e.query,
  ...
  function S(e, t) {
    ...
    if (l)
      return S(
        h(k(l), {
          state: "object" == typeof l ? h({}, o, l.state) : o,
          force: a,
          replace: s
        }),
        t || n
    ...
    return (
      ...
      !a &&
        ...
        ((u = ie(16, { to: i, from: r })), te(r, r, !0, !1)),
      (u ? Promise.resolve(u) : G(i, r))
        .catch((e) => (ue(e) ? (ue(e, 2) ? e : ee(e)) : X(e, i, r)))
        .then((e) => {
          if (e) {
            if (ue(e, 2))
              return S(
  ...
  function G(e, t) {
    ...
    const s = q.bind(null, e, t);
    return (
      n.push(s),
      ce(n)
        .then(() => {
          n = [];
          for (const r of i.list()) n.push(Ge(r, e, t));
  ...
  function U(e, t, n, r, o) {
    ...
    n &&
      (r || s
        ? l.replace(e.fullPath, h({ scroll: s && c && c.scroll }, o))
        : l.push(e.fullPath, o)),
      (v.value = e),
      te(e, t, n, s),
      ee();
  ...
  function z() {
    F ||
      (F = l.listen((e, t, n) => {
        ...
        const r = R(e),
          o = j(r);
        if (o) return void S(h(o, { replace: !0 }), r).catch(m);
        y = r;
        const a = v.value;
        var s, c;
        p && ((s = Z(a.fullPath, n.delta)), (c = Y()), J.set(s, c)),
          G(r, a)
            .catch((e) =>
              ue(e, 12)
                ? e
                ...
                ? (S(e.to, r)
                    .then((e) => {
                      ue(e, 20) && !n.delta && n.type === V.pop && l.go(-1, !1);
                    })
                    .catch(m),
                  Promise.reject())
                : (n.delta && l.go(-n.delta, !1), X(e, r, a))
            )
            .then((e) => {
              (e = e || U(r, a, !1)) &&
                (n.delta && !ue(e, 8)
                  ? l.go(-n.delta, !1)
                  : n.type === V.pop && ue(e, 20) && l.go(-1, !1)),
                I(r, a, e);
            })
            .catch(m);
      }));
  ...
  const oe = new Set(),
    se = {
      ...
      addRoute: function (e, t) {
        let n, r;
        return (
          ae(e) ? ((n = a.getRecordMatcher(e)), (r = t)) : (r = e),
          a.addRoute(r, n)
        );
      },
      ...
      install(e) {
        ...
        e.provide(qe, this), e.provide(Le, n(r)), e.provide(Me, v);
        const o = e.unmount;
        oe.add(e),
          (e.unmount = function () {
            oe.delete(e),
...
export { re as a, Ve as b, oe as c, He as d, ze as u };
